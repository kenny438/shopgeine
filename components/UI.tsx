...
export const Icons = {
  ...
  Tag: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l6.58-6.58c.94-.94.94-2.48 0-3.42L12 2Z"/><path d="M7 7h.01"/></svg>
  ),
  ...
  Megaphone: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m3 11 18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg>
  ),
  Pen: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/></svg>
  ),
  ...
  Globe: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><line x1="2" x2="22" y1="12" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1 4-10z"/></svg>
  ),
  ...
  Share: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" x2="12" y1="2" y2="15"/></svg>
  ),
  ...
  Map: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"/><line x1="9" x2="9" y1="3" y2="18"/><line x1="15" x2="15" y1="6" y2="21"/></svg>
  ),
  Cloud: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 19c0-3.037-2.463-5.5-5.5-5.5S6.5 15.963 6.5 19"/><path d="M19 19H5V8a5 5 0 0 1 9.9-1H15a4 4 0 0 1 4 4"/></svg>
  ),
  ...
  Key: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21 2-2 2m-7.6 7.6a6.5 6.5 0 1 1-2.6-2.6l1.5-1.4a2 2 0 0 1 2.8 0l.9.9a2 2 0 0 1 0 2.8z"/></svg>
  ),
  ...
  Layout: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
  ),
  Type: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/></svg>
  ),
  Smile: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>
  ),
  ...
  Book: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
  ),
  Flag: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg>
  ),
  ...
  // New Icons for Arena
  Swords: (props: React.SVGProps<SVGSVGElement>) => (
  ...
  Coins: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m7.1 13.8 3-3.07"/><path d="M10 9.8 8.4 8.2"/></svg>
  ),
  ...
  Lightbulb: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-1 1.5-2 1.5-3.5 0-3.33-2.67-6-6-6s-6 2.67-6 6c0 1.5.5 2.5 1.5 3.5.8.8 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
  )
};

// ... existing components ...
export const Button = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & { variant?: 'primary' | 'secondary' | 'danger' | 'ghost' | 'black' | 'gradient' | 'outline' }>(
  ({ className, variant = 'primary', children, ...props }, ref) => {
    // Premium / Official Aesthetics with "Clicky" feel
    const baseStyles = "group relative inline-flex items-center justify-center rounded-xl text-sm font-semibold tracking-wide transition-all duration-200 active:scale-[0.96] disabled:opacity-70 disabled:pointer-events-none px-6 py-2.5 shadow-button overflow-hidden";
    
    const variants = {
      // The requested "Original" Look: Dark gradient, subtle inner highlight, border
      black: "bg-gradient-to-b from-[#2a2a2a] to-[#000] text-white border border-[#333] shadow-[0_4px_12px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.15)] hover:shadow-[0_6px_16px_rgba(0,0,0,0.6)] hover:brightness-110",
      
      // ShopGenie Teal - Professional Gradient
      primary: "bg-gradient-to-b from-[#00C29A] to-[#00A884] text-white border border-[#008F6F] shadow-[0_4px_12px_rgba(0,168,132,0.4),inset_0_1px_0_rgba(255,255,255,0.25)] hover:shadow-[0_6px_16px_rgba(0,168,132,0.5)] hover:brightness-105",
      
      // Clean White
      secondary: "bg-white text-gray-800 border border-gray-200 shadow-sm hover:bg-gray-50 font-medium hover:border-gray-300 hover:shadow-md",
      
      // Destructive
      danger: "bg-red-50 text-red-600 border border-red-200 hover:bg-red-100 hover:border-red-300 hover:shadow-sm",
      
      ghost: "text-gray-500 hover:text-gray-900 hover:bg-gray-100/50 shadow-none border-transparent active:scale-95",
      
      gradient: "bg-gradient-to-r from-[#00A884] to-[#25D366] text-white shadow-md hover:shadow-green-500/30 border-0",
      
      outline: "bg-transparent border border-gray-300 text-gray-700 hover:bg-white hover:border-gray-400 shadow-none hover:shadow-sm"
    };
    ...
    return (
      ...
      >
        ...
        {(variant === 'primary' || variant === 'black') && (
            <div className="absolute inset-0 -translate-x-full group-hover:animate-[shine_1.5s_infinite] bg-gradient-to-r from-transparent via-white/10 to-transparent z-0 pointer-events-none" />
        )}
...
export const Input = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
  ({ className, ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={`flex h-11 w-full rounded-xl px-4 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-shop-primary/30 focus:border-shop-primary transition-all border border-gray-200 bg-white shadow-sm hover:border-gray-300 ${className || ''}`}
        {...props}
      />
    );
  }
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div className="relative">
        <select
          ref={ref}
          className={`appearance-none flex h-11 w-full rounded-xl px-4 py-2 pr-8 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-shop-primary/30 focus:border-shop-primary transition-all border border-gray-200 bg-white shadow-sm hover:border-gray-300 ${className || ''}`}
          {...props}
        >
          {children}
        </select>
...
export const TextArea = React.forwardRef<HTMLTextAreaElement, React.TextareaHTMLAttributes<HTMLTextAreaElement>>(
    ({ className, ...props }, ref) => {
      return (
        <textarea
          ref={ref}
          className={`flex w-full rounded-xl px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-shop-primary/30 focus:border-shop-primary transition-all resize-none border border-gray-200 bg-white shadow-sm hover:border-gray-300 ${className || ''}`}
          {...props}
        />
      );
    }
...
export const Toggle = ({ checked, onChange }: { checked: boolean, onChange: (val: boolean) => void }) => (
    <button 
        ...
        className={`w-11 h-6 rounded-full transition-all duration-300 relative focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-shop-primary/50 ${checked ? 'bg-shop-primary shadow-inner' : 'bg-gray-200 hover:bg-gray-300'}`}
    >
        <span className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full shadow-[0_2px_4px_rgba(0,0,0,0.2)] transition-transform duration-300 ease-spring ${checked ? 'translate-x-5' : 'translate-x-0'}`} />
    </button>
);

export const SegmentedControl = ({ options, value, onChange }: { options: { value: string; label: string }[], value: string, onChange: (val: string) => void }) => {
    return (
        <div className="flex bg-gray-100/80 backdrop-blur-sm p-1 rounded-xl border border-gray-200/60 shadow-inner">
            {options.map((option) => (
                <button
                    key={option.value}
                    type="button"
                    onClick={() => onChange(option.value)}
                    className={`flex-1 py-1.5 px-3 text-xs font-bold uppercase tracking-wider rounded-lg transition-all duration-200 ${
                        value === option.value 
                        ? 'bg-white text-gray-900 shadow-[0_2px_8px_rgba(0,0,0,0.08)] ring-1 ring-black/5 scale-[1.02]' 
...
export const Tabs = ({ options, value, onChange }: { options: string[], value: string, onChange: (val: string) => void }) => {
    return (
      <div className="flex gap-6 border-b border-gray-100 mb-6 overflow-x-auto no-scrollbar">
          {options.map(opt => (
              <button
                ...
                className={`pb-3 text-xs font-bold uppercase tracking-widest transition-all relative whitespace-nowrap px-1 hover:text-shop-primary/80 ${
                    value === opt 
                    ? 'text-shop-primary' 
                    : 'text-gray-400'
                }`}
              >
                  {opt}
                  {value === opt && (
                      <span className="absolute bottom-0 left-0 w-full h-0.5 bg-shop-primary rounded-t-full animate-fade-in"></span>
                  )}
              </button>
          ))}
      </div>
...
export const Card = ({ children, className, noHover = false, ...props }: React.HTMLAttributes<HTMLDivElement> & { noHover?: boolean }) => (
  <div 
    className={`bg-white rounded-2xl p-6 ${!noHover ? 'hover:shadow-card-hover hover:-translate-y-1' : 'shadow-card'} transition-all duration-300 border border-gray-100/80 ${className || ''}`}
    {...props}
  >
    {children}
  </div>
...
export const Badge = ({ children, color = 'green', className }: { children?: React.ReactNode; color?: 'green' | 'gray' | 'blue' | 'purple' | 'orange' | 'red' | 'indigo' | 'emerald' | 'violet'; className?: string }) => {
  ...
  return (
    <span className={`inline-flex items-center rounded-md px-2.5 py-1 text-[10px] uppercase tracking-wider font-bold ${colors[color] || colors.gray} ${className || ''}`}>
      {children}
    </span>
  );
};
